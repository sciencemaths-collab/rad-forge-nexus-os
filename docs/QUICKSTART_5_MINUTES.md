...
evidence archive from the [GitHub release](https://github.com/sciencemaths-collab/rad-forge-nexus-os/releases/tag/v0.2.0a7):
...
pipx install ./dist/nexus_os-0.2.0a7-py3-none-any.whl
rad --version
rad --help
```
...
```bash
docker pull ghcr.io/sciencemaths-collab/rad-agent:v0.2.0a7
docker run --rm ghcr.io/sciencemaths-collab/rad-agent:v0.2.0a7 --version
```
...
docker run --rm -it --network host \
  ...
  ghcr.io/sciencemaths-collab/rad-agent:v0.2.0a7 \
